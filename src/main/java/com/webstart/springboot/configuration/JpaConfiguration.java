package com.webstart.springboot.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.webstart.springboot.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.webstart.springboot.model" });
